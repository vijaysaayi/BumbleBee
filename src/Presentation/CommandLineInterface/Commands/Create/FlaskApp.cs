...
namespace Penguin.CommandLineInterface.Commands.Create
{
    public class FlaskApp
    {
        ...
        private readonly ILogger<FlaskApp> _logger;
        ...
        public FlaskApp(IMediator mediator, ILogger<FlaskApp> logger)
        {
                             ...
                             .StartAsync("Processing...", async ctx =>
                             {
                                 ...
                                 if (isResourceGroupCreateSuccessful)
                                 {
                                     ...
                                     if (appServicePlan != null)
                                     {
                                         ...
                                         if (appService != null)
                                         {
                                             string repositoryUrl = "https://github.com/Azure-Samples/python-docs-hello-world";
